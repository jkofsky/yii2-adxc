...
<article>
    ...
    <div class="section post-body">
        <p>
            ...
            <img style="width: 400px; height: 300px;" title="rsync commands"
                 class="img-right img-responsive"
                 alt=""
                 src="<?= \Yii::getAlias('web'); ?>/images/engineering/RsyncCommand.png">
        ...
        <p>To sync two directories in a local computer, use the following
            rsync -zvr command.</p>
        <code>$ rsync -zvr /var/opt/installation/inventory/ /root/temp</code>
                ...
                <tr>
                    <td valign = "top">
                        <ol>
                            ...
                            <li><a href="https://www.thegeekstuff.com/linux-101-hacks-ebook/" target="_blank">Linux 101 Hacks 2nd Edition eBook</a> <?= Html::bsLabel('Free', 'danger');
    ?></li>
                        </ol>
                    </td>
                    <td>
