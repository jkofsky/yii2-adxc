...
<div class="row-1">
    ...
    <table class="table table-bordered table-striped text-monospace">
        <thead><tr>
                <th>RFC1918 name</th>
    ...
    <table class="table table-bordered text-monospace">
        <thead>
            <tr>
            ...
            <tr>
                <th class="text-left" colspan="3"><h3>4.  Summary Table</h3></th>
            </tr>
            <tr class="bg-light">
                <th>Address Block</th>
                <th>Present Use</th>
